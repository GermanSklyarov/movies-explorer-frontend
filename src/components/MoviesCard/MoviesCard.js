...
function MoviesCard({
  ...
  const isSaved = isSavedMovies
    ? true
    : savedMovies.find((savedCard) => savedCard.movieId === card.id);
  return (
    <li className="movies__card">
      <div className="movies__card-caption">
        ...
        {!isSavedMovies && (
          <button
            type="button"
            className="movies__card-button movies__card-button-save"
            onClick={() => handleCardButtonClick(card)}
          >
            <img
              className="movies__button-icon"
        ...
        {isSavedMovies && (
          <button
            type="button"
            className="movies__card-button movies__card-button-delete"
            onClick={() => handleCardButtonClick(card)}
          >
            <img
              className="movies__button-icon"
